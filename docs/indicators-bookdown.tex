...
\begin{Highlighting}[]
\CommentTok{\# confirm that the only variable recorded here is "abondance"}
\NormalTok{papillons}\OperatorTok{$}\NormalTok{var }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{unique }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}\KeywordTok{stopifnot}\NormalTok{(. }\OperatorTok{==}\StringTok{ "abondance"}\NormalTok{)\}}


\CommentTok{\#\# are sites nested in cells? }

\NormalTok{papillons }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(site\_code, cell\_code) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{distinct }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(cell\_code) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{tally}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{indicators-bookdown_files/figure-latex/fig_rank_abd_pap-1.pdf}
...
\includegraphics{indicators-bookdown_files/figure-latex/order_plot-1.pdf}
...
\includegraphics{indicators-bookdown_files/figure-latex/indiv_raref-1.pdf}
